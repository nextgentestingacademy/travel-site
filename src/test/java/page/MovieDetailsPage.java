...
//		Thread.sleep(2000);
	...
	public void handleLanguageSelectIfPresent(String language) {
...
//		return this;
	...
	public void addFilter(int day, String format, String showTime, String priceRange, String others) throws InterruptedException {
		rating = checkRating();
...
//		return this;
	...
	public void selectTheatreAndShow(String theatre, String time) throws InterruptedException {
		Thread.sleep(2000);
		if(theatre!="") {
