...
//		Thread.sleep(2000);
	...
	public PaymentPage handleLanguageSelectIfPresent(String language) {
	...
	public PaymentPage addFilter(int day, String format, String showTime, String priceRange, String others) throws InterruptedException {
		rating = checkRating();
	...
	public PaymentPage selectTheatreAndShow(String theatre, String time) throws InterruptedException {
		Thread.sleep(2000);
		if(theatre!="") {
